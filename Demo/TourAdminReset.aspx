<%@ Page Title="" Language="C#" MasterPageFile="~/MainHeader.Master" AutoEventWireup="true" CodeBehind="TourAdminReset.aspx.cs" Inherits="Demo.TourAdminReset" %>
                         ...
                         <div class="row">
                             <div class="col">
                                 ...
                                 <div class="form-group">
                                     <asp:TextBox CssClass="form-control" ID="txtnpass" runat="server" placeholder="New Password" TextMode="Password" MinLength="6" BorderColor="Black" Font-Bold="True"></asp:TextBox>
                                 </div>
                                 <br />
  &nbsp; 
                                 ...
                                 <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="txtnpass" ErrorMessage="Check Password" Font-Bold="True" Font-Italic="True" ForeColor="Red" ControlToValidate="txtcpass"></asp:CompareValidator>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <asp:Button class="btn btn-outline-success col-9 btn-lg  " ID="btnreset" runat="server" Text="Reset" OnClick="btnreset_Click"  />
                                 </div>                                                   
                                 <br />
