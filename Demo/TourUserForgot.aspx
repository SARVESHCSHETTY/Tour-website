<%@ Page Title="" Language="C#" MasterPageFile="~/MainHeader.Master" AutoEventWireup="true" CodeBehind="TourUserForgot.aspx.cs" Inherits="Demo.TourUserForgot" %>
                         ...
                         <br />
                          <div class="row">
                             <div class="col-md-9">
                                   ...
                                   &nbsp; 
                                 <asp:Image ID="Image3" runat="server"  src="images/mail.jpg"  width="30" height="30"  />&nbsp;<asp:Label ID="Label3" runat="server" Text="User Email-id" Font-Bold="True"></asp:Label>
                             ...
                             <div class="col-md-3">
                                 ...
                                 <asp:Button ID="Button1" CssClass="btn btn-outline-info" runat="server" Text="Send OTP" OnClick="Button1_Click" />                              
                         </div>
                             </div>
                          <div class="row">
                             <div class="col-md-9">
                                 ...
                                 <br />
                                  ...
                                  <div class="form-group">
                                      ...
                                      <asp:Button  class="btn btn-outline-success col-9 btn-lg" ID="Button2" runat="server" Text="Verify" OnClick="Button2_Click"/>
